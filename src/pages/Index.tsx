        ...
        <Card className="w-full max-w-md shadow-elegant">
          <CardHeader className="text-center">
            <div className="flex justify-center mb-4">
              <div className="p-4 bg-gradient-wood rounded-full">
                <TreePine className="h-8 w-8 text-primary-foreground" />
              </div>
            </div>
            <CardTitle className="text-2xl">Plataforma de Controle</CardTitle>
            <p className="text-sm text-muted-foreground mt-2">Sistema de Gestão de Madeiras</p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <p className="text-xs text-muted-foreground text-center">
                Protótipo com autenticação simulada
              </p>
            </form>
          </CardContent>
        </Card>
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <footer className="text-center text-sm text-muted-foreground py-6">
        Plataforma de Controle de Madeiras - Protótipo
      </footer>
    </div>
  );
};
